...
#######################################################################################################################
    ...
    def _gen_embed(self):
        ...
        e = discord.Embed()
        e.colour = 0xff1a1a
        e.set_footer(text='RoyalNetwork ({})'.format(BOTVERSION), icon_url='http://thegreaserandthedoll.com/media/catalog/product/cache/3/image/1200x1200/9df78eab33525d08d6e5fb8d27136e95/k/e/ketchup-bottle_1.jpg')
        e.set_author(name=self.user.name, url='http://discord.royalnetwork.eu', icon_url=self.user.avatar_url)
        return e
